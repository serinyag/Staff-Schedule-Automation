  ...
  return (
    <>
      <div className="hidden xl:block">
        <div className="grid grid-cols-[minmax(14rem,1.5fr)_minmax(15rem,1.25fr)_8rem_10rem_11rem_8rem] gap-4 px-4 pb-3 text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">
        ...
        <div className="space-y-3">
          {records.map((record) => {
            ...
            return (
              <div
                key={record.id}
                className="grid grid-cols-[minmax(14rem,1.5fr)_minmax(15rem,1.25fr)_8rem_10rem_11rem_8rem] gap-4 rounded-[1.6rem] border border-slate-200 bg-white px-4 py-4 shadow-[0_12px_40px_rgba(15,23,42,0.06)]"
              >
